...
module axis_capture (
    ...
    // stream in (16-bit here: module 21's samples are Q1.15 - this copy
    // diverges from module 12's original in width only)
    ...
    always @(posedge aclk) begin
        if (!aresetn) begin
            ...
            last_data  <= {{16{s_axis_tdata[15]}}, s_axis_tdata};  // sign-extend Q1.15
