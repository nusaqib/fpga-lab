## sw/led extracted from boards/nexys4/xdc/Nexys4-Master.xdc as in modules
## 00-02; new this module: the 100MHz clock (sch name CLK100MHZ) with its
## create_clock, and the center pushbutton (sch name BTNC).
