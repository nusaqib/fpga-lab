...
if {$bd_tcl ne ""} {
    ...
    foreach bd [get_files -quiet *.bd] {
        # Some IPs (e.g. SmartConnect spanning clock domains) expand into
        # NESTED sub-BDs; those are generated by their parent and error out
        # if targeted directly (Vivado 12-3563). Only user-level BDs - the
        # ones with no parent composite - get generated/wrapped here.
        if {[get_property -quiet PARENT_COMPOSITE_FILE $bd] ne ""} { continue }
